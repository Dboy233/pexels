...
class CustomInterceptors extends InterceptorsWrapper {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    if (User_Auth!=null&& User_Auth != options.headers["Authorization"]) {
      ...
      Get.log("$TAG REQUEST[${options.method}] => Fix Auth:$User_Auth");
    }
    Get.log("$TAG REQUEST[${options.method}] => PATH: ${options.uri}");
    Get.log("$TAG REQUEST[${options.method}] => HEAD: ${options.headers}");
